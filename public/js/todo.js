...
var view = {
  ...
  checkTodosCompletion: function () {
    ...
    var todosRightLabel = document.getElementById('todosRight');
    ...
    switch (uncompletedTodos) {
      case 0:
        ...
        break;
      default:
        todosLeftLabel.textContent = "" + uncompletedTodos;
    }

    switch (completedTodos) {
      case 0:
        todosRightLabel.textContent = '';
        break;
      default:
        todosRightLabel.textContent = "" + completedTodos;
    }
